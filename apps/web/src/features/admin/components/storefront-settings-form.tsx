  ...
  async function handleSave() {
    ...
    try {
      await updateSettings.mutateAsync({
        topBannerImages,
        secondBannerImages,
        heroPrimaryCategoryId:
          heroPrimaryCategoryId === NONE_VALUE ? null : heroPrimaryCategoryId,
        heroSecondaryCategoryId:
          heroSecondaryCategoryId === NONE_VALUE
            ? null
            : heroSecondaryCategoryId,
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4 rounded-2xl border border-border bg-card p-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            The two categories shown in the large featured section. Their most
            recent product is displayed automatically.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select
              value={heroPrimaryCategoryId}
              onValueChange={(value) => setHeroPrimaryCategoryId(value ?? "")}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={heroSecondaryCategoryId}
              onValueChange={(value) => setHeroSecondaryCategoryId(value ?? "")}
            >
              <SelectTrigger>
                <SelectValue placeholder="Choose a category" />
              </SelectTrigger>
