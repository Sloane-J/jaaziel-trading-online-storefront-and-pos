...
export function AttributesBuilder({
	...
	function removeRow(index: number) {
		...
		const finalRows = next.length > 0 ? next : [{ key: "", value: "" }];
		setRows(finalRows);
		onChange(toAttributes(finalRows));
	}
	...
	return (
		<div className="space-y-2">
			...
			<p className="text-sm text-muted-foreground">
				Add extra details specific to this product, like color, size, or
				material.
			</p>
